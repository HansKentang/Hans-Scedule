        ...
        if (_spActivePlaylist) {
          ...
          return `<div class="bento-bubble" data-bubble="${uid}" style="${dimStyle};background:var(--surface-container-low);padding:0;border:1px solid var(--border-color);overflow:hidden">
            ...
            <div class="spotify-widget">
              ...
              <iframe src="${e(spotUrl)}" width="100%" height="80" frameborder="0" allowtransparency="true" allow="encrypted-media" style="display:block;width:100%;height:152px;border-radius:20px"></iframe>
            </div>
          </div>`;
        } else {
